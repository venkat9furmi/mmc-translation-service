...
def build_cell_map(doc):
    ...
    IMPORTANT: table type is detected by the HEADER ROW content, not by
    table index. Some scripts have a dedicated running-order table first
...
def health():
    return jsonify({
        ...
        "code_version": "2026-06-23-header-detection-fix-v3",
    })
