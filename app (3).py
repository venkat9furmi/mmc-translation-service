...
def call_groq(prompt, api_key, max_retries=3):
    """
    Calls Groq with sane token sizing + automatic 429 backoff.
    ...
    on a single call. We also honor Groq's Retry-After header on 429s.
    """
    headers = {
